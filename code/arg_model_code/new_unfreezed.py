...
"""
The new fine-tuning script for fine-tuning the RoBERTa Extended model - updated to use the new feature engineering (projection of features using a linear layer) and data processing methods
"""
...
model = RoBERTaEnhancedUnfreezed.from_pretrained("roberta-base", feature_dim=train_features.shape[1], num_labels=2)
